    ...
    <div className={cn(
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <MessageList 
          ...
          isLoading={isLoading}
          className="flex-1 h-full" /* Ensuring MessageList takes full height */
        />
      </div>
      
      {/* Input container - Apply safe area padding here only */}
      <div className="border-t border-gray-200 dark:border-slate-700/50 bg-white dark:bg-slate-900/90 dark:backdrop-blur-md p-2 sm:p-4 pb-safe-bottom">
        <MessageInput
