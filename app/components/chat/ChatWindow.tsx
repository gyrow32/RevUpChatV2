...
export default function ChatWindow({ className = '' }: ChatWindowProps) {
  ...
  return (
    <div className={cn(
      ...
      <div className="fixed top-0 left-0 right-0 z-50 border-b bg-white dark:bg-slate-900/80 dark:backdrop-blur-xl border-gray-200 dark:border-slate-700/50 shadow-sm dark:shadow-xl px-2 sm:px-6 overflow-hidden" style={{ height: 'var(--header-height-mobile)', maxHeight: 'var(--header-height-mobile)' }}>
      ...
      {/* Messages container - With proper height constraints for scrolling */}
      <div className="flex-1 flex flex-col overflow-hidden pt-header">
        <MessageList 
          messages={messages}
          onRetry={retryMessage}
          onQuestionClick={handleQuestionClick}
          isLoading={isLoading}
          className="flex-1" /* Ensuring MessageList takes proper height */
        />
      </div>
      
      {/* Input container - Apply safe area padding here only */}
      <div className="sticky bottom-0 z-40 border-t border-gray-200 dark:border-slate-700/50 bg-white dark:bg-slate-900/90 dark:backdrop-blur-md p-2 sm:p-4 pb-safe-bottom">
        <MessageInput
