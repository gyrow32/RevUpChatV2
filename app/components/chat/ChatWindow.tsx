...
export default function ChatWindow({ className = '' }: ChatWindowProps) {
  ...
  return (
    <div className={cn(
      ...
      <div className="sticky top-0 z-50 border-b bg-white dark:bg-slate-900/80 dark:backdrop-blur-xl border-gray-200 dark:border-slate-700/50 shadow-sm dark:shadow-xl px-2 sm:px-6 overflow-hidden">
