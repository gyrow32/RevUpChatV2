    ...
    >
      ...
      <div className="relative">
        ...
        >
          {/* Vehicle Cards */}
          <div 
            className="flex transition-transform duration-500 ease-out gap-0 sm:gap-4 items-stretch min-h-[560px] sm:min-h-[580px] md:min-h-[600px]"
            style={{ 
            ...
            {normalizedVehicles.map((vehicle, vehicleIndex) => {
              ...
              return (
                ...
                >
                  <VehicleCard 
                    vehicle={vehicle} 
                    className="h-full max-h-[560px] sm:max-h-[580px] md:max-h-[600px] mx-auto" 
